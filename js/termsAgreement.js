...
/***/ "./src/imports/TermsAgreementHandler.ts":
/*!**********************************************!*\
  !*** ./src/imports/TermsAgreementHandler.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ TermsAgreementHandler)
/* harmony export */ });
...
class TermsAgreementHandler {
    // eslint-disable-next-line @typescript-eslint/no-empty-function
    constructor() {
    }
    getAgreementStatus(version) {
        return __awaiter(this, void 0, void 0, function* () {
            const { data: status } = yield this.isAgreed(version);
            if (status == null) {
    ...
    setAgreed(version) {
        return __awaiter(this, void 0, void 0, function* () {
            const { data: status } = yield this.agreed(version);
    ...
    isAgreed(version) {
        const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/apps/sendent/api/1.0/termsagreement/isagreed/' + version);
        return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(url);
    }
    agreed(version) {
        const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/apps/sendent/api/1.0/termsagreement/agree/' + version);
        return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(url);
    }
}
...
"use strict";
/*!*******************************!*\
  !*** ./src/termsAgreement.ts ***!
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _imports_TermsAgreementHandler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./imports/TermsAgreementHandler */ "./src/imports/TermsAgreementHandler.ts");
...
$(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if ((yield _imports_TermsAgreementHandler__WEBPACK_IMPORTED_MODULE_0__["default"].setup().getAgreementStatus("1.2.8")) != true) {
        showAgreement();
    }
    else {
        hideAgreement();
...
function handleChange(checkbox) {
    return __awaiter(this, void 0, void 0, function* () {
        if (checkbox.checked == true) {
            if (yield _imports_TermsAgreementHandler__WEBPACK_IMPORTED_MODULE_0__["default"].setup().setAgreed("1.2.8")) {
...
function hideAgreement() {
    ...
    // Activate general tab bar
    $('.tabmenu > .tablink').on('click', function (ev) {
        // Get all elements with class="tabcontent" and hide them
        $(".Settingspage").css('display', 'none');
        // Get all elements with class="tablinks" and remove the class "active"
        $(".tabmenu > .tablink").removeClass("active");
    ...
    // Activate general tab bar
    $('.subtab-menu > .tablink').on('click', function (ev) {
        // Get all elements with class="tabcontent" and hide them
        $(".SettingsGroup").css('display', 'none');
        // Get all elements with class="tablinks" and remove the class "active"
        $(".subtab-menu > .tablink").removeClass("active");
        // Show the current tab, and add an "active" class to the button that opened the tab
        let tabName = ev.currentTarget.id;
        tabName = "#" + tabName.substring(4);
        $(tabName).css('display', 'block');
...
/******/ })()
;
//# sourceMappingURL=termsAgreement.js.map