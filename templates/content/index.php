    ...
    <div class="settingTemplateDetailInclude section" id="generalsettings">
        ...
        <form class="form" method="post" id="settingsform">
            ...
            <div class="settingTemplateDetailInclude section" id="generalsettings">
                ...
                <div class="personal-settings-setting-box" id="insertatcursor">
                    <div id="insertatcursor" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Insert snippet
                                location</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                ...
                <div class="personal-settings-setting-box" id="dateaddition">
                    <div id="dateaddition" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Add upload date to folder
                                path</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                ...
                <div class="personal-settings-setting-box" id="passwordcontrolbehavior">
                    <div id="passwordcontrolbehavior" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Password control
                                behavior</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <select class="settingkeyvalueinput" type="select" name="settingkeyvalueinput"
                            id="passwordcontrolbehavior">
                ...
                <div class="personal-settings-setting-box" id="sendmode">
                    <div id="sendmode" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Password communication
                                mode</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                ...
                <div class="personal-settings-setting-box" id="htmlsnippetpassword">
                    <div id="htmlsnippetpassword" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeynametextareakind" for="templatesettingkeyname">Password
                                communication snippet</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
            ...
            <div class="settingTemplateDetailInclude section" id="domainExceptions">
                ...
                <div class="personal-settings-setting-box" id="talkenabled">
                    <div id="talkenabled" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Activate Talk</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <select class="settingkeyvalueinput" type="select" name="settingkeyvalueinput"
                        ...
                        <input type="hidden" id="settingkeyname" value="talkenabled">
                        <input type="hidden" id="settingkeytemplateid" value="0">
                        <input type="hidden" id="settinggroupid" value="0">
                        <input type="hidden" id="settingkeykey" value="202">
                        <input type="hidden" id="settingkeyid" value="202">
                    </div>
                </div>
            ...
            <div class="settingTemplateDetailInclude section" id="domainExceptions">
                ...
                <div class="personal-settings-setting-box" id="attachmentdomainexceptionsinternal">
                    <div id="attachmentdomainexceptionsinternal" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Internal domain
                                exceptions</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput" type="text" name="settingkeyvalueinput"
                            id="attachmentdomainexceptionsinternal" value=""
                            placeholder="yourdomain.com;info@yourotherdomain.com" autocomplete="on"
                ...
                <div class="personal-settings-setting-box" id="attachmentdomainexceptions">
                    <div id="attachmentdomainexceptions" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">External domain
                                exceptions</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput" type="text" name="settingkeyvalue"
                            id="attachmentdomainexceptions" value=""
                            placeholder="thirdparty-domain.com;info@thirdparty-domain.com" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="attachmentdomainexceptionsexternalpopup">
                    <div id="attachmentdomainexceptionsexternalpopup" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">External domain exception
                                notification</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
            ...
            <div class="settingTemplateDetailInclude section" id="attachments">
                ...
                <div class="personal-settings-setting-box" id="attachmentsize">
                    <div id="attachmentsize" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Auto upload attachment
                                size
                                (MB)</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput" type="numeric" name="settingkeyvalueinput"
                            id="attachmentsize" value="1" placeholder="e.g: 10" autocomplete="on" autocapitalize="none"
                            autocorrect="off">
            ...
            <div class="settingTemplateDetailInclude section" id="filehandling">
                ...
                <div class="personal-settings-setting-box" id="pathuploadfiles">
                    <div id="pathuploadfiles" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Path for Share
                                Files</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput" type="text" name="settingkeyvalueinput" id="pathuploadfiles"
                            value="" placeholder="e.g: /Outlook/Public-Share/" autocomplete="on" autocapitalize="none"
                            autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="pathpublicshare">
                    <div id="pathpublicshare" class="settingkeyvalue">
                        ...
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput" type="text" name="settingkeyvalueinput" id="pathpublicshare"
                            value="" placeholder="e.g:/Outlook/Upload-Share/" autocomplete="on" autocapitalize="none"
                            autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="sharefolderhtml">
                    <div id="sharefolderhtml" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeynametextareakind" for="templatesettingkeyname">Share Public
                                Folder
                                snippet</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
            ...
            <div class="settingTemplateDetailInclude section" id="securemail">
                ...
                <div class="personal-settings-setting-box" id="securemail">
                    <div id="securemail" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Activate Secure
                                Mail</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                ...
                <div class="personal-settings-setting-box" id="pathsecuremailbox">
                    <div id="pathsecuremailbox" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Path for Secure
                                Mail</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput" type="text" name="settingkeyvalueinput"
                            id="pathsecuremailbox" value="" placeholder="e.g: /Outlook/SecureMail-Share/"
                ...
                <div class="personal-settings-setting-box" id="securemailhtml">
                    <div id="securemailhtml" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeynametextareakind" for="templatesettingkeyname">Secure Mail
                                snippet</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
            ...
            <div class="settingTemplateDetailInclude section" id="guestaccounts">
                ...
                <div class="personal-settings-setting-box" id="guestaccountsenabled">
                    <div id="guestaccountsenabled" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Activate Guest
                                accounts</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                ...
                <div class="personal-settings-setting-box" id="guestaccountsenforced">
                    <div id="guestaccountsenforced" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Enforce Guest
                                accounts</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <select class="settingkeyvalueinput" type="select" name="settingkeyvalueinput"
                            id="guestaccountsenforced">
                            <option value="True">Enabled</option>
                            <option selected value="False">Disabled</option>
                        </select>
            ...
            <div class="settingTemplateDetailInclude section" id="AdvancedTheming">
                ...
                <div class="personal-settings-setting-box" id="AdvancedThemingEnabled">
                    <div id="AdvancedThemingEnabled" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Advanced Theming
                                enabled</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                ...
                <div class="personal-settings-setting-box" id="VendorName">
                    <div id="VendorName" class="settingkeyvalue">
                        ...
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput" type="text" name="settingkeyvalueinput" id="VendorName"
                            value="" placeholder="Sendent" autocomplete="on" autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="ButtonPrimaryColor">
                    <div id="ButtonPrimaryColor" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Button primary -
                                color</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="ButtonPrimaryColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="ButtonPrimaryFontColor">
                    <div id="ButtonPrimaryFontColor" class="settingkeyvalue">
                        ...
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="ButtonPrimaryFontColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="ButtonPrimaryHoverColor">
                    <div id="ButtonPrimaryHoverColor" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Button primary - hover
                                color</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="ButtonPrimaryHoverColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="ButtonPrimaryIconColor">
                    <div id="ButtonPrimaryIconColor" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Button primary - icon
                                color
                            </span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="ButtonPrimaryIconColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="ButtonSecondaryColor">
                    <div id="ButtonSecondaryColor" class="settingkeyvalue">
                        ...
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="ButtonSecondaryColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="ButtonSecondaryFontColor">
                    <div id="ButtonSecondaryFontColor" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Button secondary -
                                font-color
                            </span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="ButtonSecondaryFontColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="ButtonSecondaryHoverColor">
                    <div id="ButtonSecondaryHoverColor" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Button secondary - hover
                                color
                            </span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="ButtonSecondaryHoverColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="ButtonSecondaryIconColor">
                    <div id="ButtonSecondaryIconColor" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Button secondary - icon
                                color
                            </span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="ButtonSecondaryIconColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="DialogFooterBackgroundColor">
                    <div id="DialogFooterBackgroundColor" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Dialog - footer
                                background-color
                            </span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="DialogFooterBackgroundColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="DialogFooterFontColor">
                    <div id="DialogFooterFontColor" class="settingkeyvalue">
                        ...
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="DialogFooterFontColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="DialogFooterHoverColor">
                    <div id="DialogFooterHoverColor" class="settingkeyvalue">
                        ...
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="DialogFooterHoverColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="DialogFooterIconColor">
                    <div id="DialogFooterIconColor" class="settingkeyvalue">
                        ...
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="DialogFooterIconColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="DialogFooterIconBackgroundColor">
                    <div id="DialogFooterIconBackgroundColor" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Dialog - footer icon
                ...
                <div class="personal-settings-setting-box" id="DialogHeaderColor">
                    <div id="DialogHeaderColor" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Dialog - header
                                color</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="DialogHeaderColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="DialogHeaderFontColor">
                    <div id="DialogHeaderFontColor" class="settingkeyvalue">
                        ...
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="DialogHeaderFontColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="PopupBackgroundColor">
                    <div id="PopupBackgroundColor" class="settingkeyvalue">
                        ...
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="PopupBackgroundColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="GeneralFontColor" style="display:none">
                    <div id="GeneralFontColor" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">General font -
                                color</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input id="GeneralFontColor" class="settingkeyvalueinput theming-color"
                            name="settingkeyvalueinput" type="text" maxlength="7" value="" autocomplete="on"
                            autocapitalize="none" autocorrect="off" />
                ...
                <div class="personal-settings-setting-box" id="TaskpaneActivityTrackerColor">
                    <div id="TaskpaneActivityTrackerColor" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Taskpane - Activity
                                Tracker - color</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="TaskpaneActivityTrackerColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="TaskpaneSecureMailColor">
                    <div id="TaskpaneSecureMailColor" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Taskpane - Secure Mail -
                                color</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="TaskpaneSecureMailColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
                ...
                <div class="personal-settings-setting-box" id="TaskpaneSecureMailFontColor">
                    <div id="TaskpaneSecureMailFontColor" class="settingkeyvalue">
                        ...
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput theming-color" type="text" name="settingkeyvalueinput"
                            id="TaskpaneSecureMailFontColor" value="" placeholder="#FFFFFF" autocomplete="on"
                            autocapitalize="none" autocorrect="off">
            ...
            <div class="settingTemplateDetailExclude section" id="license">
                ...
                <div class="license-settings-setting-box" id="licenseMessage">
                    <div id="licenseMessage" class="settingkeyvalue">
                        ...
                        <div class="labelFullWidth" id="lblLicenseMessage"
                            ...
                            PLEASE NOTE: We made some adjustments in our licensing and will implement this gradually in
                            several phases to our paid customers. If you haven't received your license key with
                            instructions yet, you don't have to take action at this moment. You will receive a
                            notification from our Team when it's your turn.<br><br>
                ...
                <div class="license-settings-setting-box" id="licensekey">
                    <div id="licensekey" class="settingkeyvalue">
                        ...
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput" type="text" name="settingkeyvalueinput" id="licensekey"
                            value="" placeholder="Put your licensekey here" autocomplete="on" autocapitalize="none"
                            autocorrect="off">
                ...
                <div class="license-settings-setting-box" id="licenseEmail">
                    <div id="licenseEmail" class="settingkeyvalue">
                        <label>
                            <span class="templatesettingkeyname" for="templatesettingkeyname">Licensed email
                                address</span>
                        </label>
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <input class="settingkeyvalueinput" type="text" name="settingkeyvalueinput" id="licenseEmail"
                            value="" placeholder="Enter email address" autocomplete="on" autocapitalize="none"
                            autocorrect="off">
                ...
                <div class="license-settings-setting-box" id="licenselevel">
                    <div id="licenselevel" class="settingkeyvalue">
                        ...
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <span class="settingkeyvalueinput licenseitem" name="settingkeyvalueinput" id="licenselevel">
                            <div class="spinner">
                ...
                <div class="license-settings-setting-box" id="licensestatus">
                    <div id="licensestatus" class="settingkeyvalue">
                        ...
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <span class="settingkeyvalueinput licenseitem" name="settingkeyvalueinput" id="licensestatus">
                            <div class="spinner">
                                <div class="bounce1"></div>
                                <div class="bounce2"></div>
                                <div class="bounce3"></div>
                ...
                <div class="license-settings-setting-box" id="licenseexpires">
                    <div id="licenseexpires" class="settingkeyvalue">
                        ...
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <span class="settingkeyvalueinput licenseitem" name="settingkeyvalueinput" id="licenseexpires">
                            <div class="spinner">
                                <div class="bounce1"></div>
                                <div class="bounce2"></div>
                                <div class="bounce3"></div>
                ...
                <div class="license-settings-setting-box" id="licenselastcheck">
                    <div id="licenselastcheck" class="settingkeyvalue">
                        ...
                        <div id="status-error" class="icon-error error hidden"></div>
                        <div id="status-ok" class="icon-checkmark ok hidden"></div>
                        <span class="settingkeyvalueinput licenseitem" name="settingkeyvalueinput"
                            id="licenselastcheck">
                            <div class="spinner">
                                <div class="bounce1"></div>
                                <div class="bounce2"></div>
